...
void SelectorEfficiency::RecordPassedSelector(const NucleiAnalysisTree& tree) {
...
void SelectorEfficiency::RecordFailedSelector(const NucleiAnalysisTree& tree, unsigned int failedCutIndex) {
