...
public:
  ...
  void Initialize(Utilities::ObjectManager&, Utilities::ObjectManager& cutsObjectManager, Cuts::AxisInformation::Expression, NucleiAnalysisTree*, IO::TreeReader*, const std::string& directoryInFile = "");
  void Initialize(Utilities::ObjectManager&, Utilities::ObjectManager& cutsObjectManager, Cuts::AxisInformation::Expression, NucleiAnalysisTree*, IO::TreeReader*, const Binning::Functions::BinningFunction& xAxisDataBinning, const std::string& directoryInFile = "");
